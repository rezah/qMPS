...
plt.plot( x, errorl6p, '--D',lw=2,color = '#72cfbb',markersize=11, label=r'QC-l, $\tau=6$')
...
plt.plot( x, errorl12, '--s', lw=2,color = '#e90ff5',markersize=11, label=r'QC-b, $\tau=12$')
...
plt.plot( xMq2, errorMq2, '--o', lw=2,color = '#5c3566',markersize=11, label=r'qMERA, $q=2, \tau=8$')
