...
#plt.loglog( xdmrg, errordmrg, '--h', markersize=11,color = '#73d216', label='dMPS (DMRG), D=16')
...
#plt.title('qmps')
plt.ylabel(r'$\delta C(r)$',fontsize=18)
