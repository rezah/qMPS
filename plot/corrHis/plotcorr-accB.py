...
plt.plot( x, errorl6p, '--h', color = '#e30b69',markersize=12, label=r'$QC-p, \tau=6$')

plt.plot( x, errorl7p, '--s', color = '#e30b69',markersize=12, label=r'$QC-p, \tau=7$')

plt.loglog( x, errorl12,'--v', color = '#cf729d',markersize=15, label=r'$QC-b, \tau=12$')
